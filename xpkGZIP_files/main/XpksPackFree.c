/*
 *  $VER: XpksPackFree.c $Revision$ (21-Nov-2004)
 *
...
/****** xpkGZIP/main/XpksPackFree ******************************************
*
*   NAME
*      XpksPackFree -- Description
*
*   SYNOPSIS
*      void XpksPackFree(struct XpkSubParams * xpar);
*
*   FUNCTION
*
*   INPUTS
...
void _XpkSub_XpksPackFree(struct XpkSubIFace *Self,
