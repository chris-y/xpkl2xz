/*
 *  $VER: XpksPackReset.c $Revision$ (21-Nov-2004)
 *
...
/****** xpkGZIP/main/XpksPackReset ******************************************
*
*   NAME
*      XpksPackReset -- Description
*
*   SYNOPSIS
*      LONG XpksPackReset(struct XpkSubParams * xpar);
*
*   FUNCTION
*
*   INPUTS
...
LONG _XpkSub_XpksPackReset(struct XpkSubIFace *Self,
